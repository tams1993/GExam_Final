...
public class OpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE_STUDENT_UNBLOCK = "create table student_unblock (_id integer primary key, " + " std_id VARCHAR(255), test_code VARCHAR(255))";
    ...
    private static final String DATABASE_CREATE_STUDENT_ILLEGAL = "create table student_illegal (_id integer primary key, " + " std_id VARCHAR(255), test_code INT(10), status INT(10))";
    ...
    private static final String DATABASE_CREATE_QUESTION = "create table questions (_id integer primary key, " + " subject_code VARCHAR(255), question VARCHAR(255), teacher_name int(255),photo VARCHAR(255),question_id INT(10))";
    ...
    private static final String DATABASE_CREATE_TEACHERS = "create table teacher (_id integer primary key, " + " phone INT, name VARCHAR(255), surname VARCHAR(255),invite_code VARCHAR(255),email VARCHAR(255),username VARCHAR(255),password VARCHAR(255), active INT)";
