...
public class OpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE_EXAM_RULE = "create table exam_rule (_id integer primary key, " + " course_id INT(10), rule VARCHAR(255), teacher_id INT(10))";
    ...
    private static final String DATABASE_CREATE_STUDENTS = "create table students (_id integer primary key, " + " phone INT(10), name VARCHAR(255), surname VARCHAR(255),photo VARCHAR(255),email VARCHAR(255),username VARCHAR(255),password VARCHAR(255), student_id VARCHAR(255),class_id INT(10))";
